export default function Landing({ onStart, onNavigate }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      {/* Hero */}
      <div className="flex flex-col items-center text-center px-6 pt-16 pb-20">
        ...
        <h1 className="text-5xl font-extrabold text-gray-800 max-w-2xl leading-tight mb-6">
        ...
        <button
          onClick={onStart}
          className="bg-green-600 text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-green-700 transition shadow-lg">
      ...
      {/* Features */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-10 pb-20 max-w-5xl mx-auto">
        {[
      ...
      <div className="bg-green-600 text-white text-center py-14 px-6">
        ...
        <button
          onClick={onStart}
          className="bg-white text-green-700 font-bold px-8 py-4 rounded-full text-lg hover:bg-green-50 transition">
          Start For Free →
        </button>
      </div>
